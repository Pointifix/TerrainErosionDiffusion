...
public final class TerrainDiffusionConfig {
    ...
    public static String inferenceDevice() {
        String sysProp = System.getProperty("terrain_diffusion.inference_device");
        if (sysProp != null) return sysProp.trim().toLowerCase();
    ...
    public static boolean offloadModels() {
        String sysProp = System.getProperty("terrain_diffusion.offload_models");
    ...
    public static int explorerPort() {
        String sysProp = System.getProperty("terrain_diffusion.explorer_port");
        if (sysProp != null) {
    ...
    public static boolean validateModel() {
        String sysProp = System.getProperty("terrain_diffusion.validate_model");
        if (sysProp != null) return Boolean.parseBoolean(sysProp.trim());
